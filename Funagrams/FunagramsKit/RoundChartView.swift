...
//  Funagrams
//
//  Created by Saravanan ImmaMaheswaran on 4/9/17.
//  Copyright © 2017 pluggablez. All rights reserved.
//

import UIKit

public class RoundChartView: UIView {
    
    @IBInspectable public var chartThickness: CGFloat = 0 {
        didSet {
    ...
    @IBInspectable public var chartColor: UIColor {
        set {
    ...
    */
    ...
    public func show(percentage: Int, delay: TimeInterval) {
    ...
    public func animation(percentage: Int, duration: TimeInterval, timingFunction:CAMediaTimingFunction) -> CABasicAnimation {
